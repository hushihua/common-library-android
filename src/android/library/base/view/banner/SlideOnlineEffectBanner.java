 ...
 *
 */
public class SlideOnlineEffectBanner extends FrameLayout implements OnPageChangeListener{

	private LinearLayout imageContent;
	private ImageView[] tips;
	private ViewPager viewPager;
	
	public SlideOnlineEffectBanner(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initView();
	}

	public SlideOnlineEffectBanner(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		initView();
	}
	...
	private void initView(){
		...
		RelativeLayout loadingLayout = new RelativeLayout(getContext());
		ProgressBar loading = new ProgressBar(getContext());
		android.widget.RelativeLayout.LayoutParams loadingParams = new android.widget.RelativeLayout.LayoutParams(android.widget.RelativeLayout.LayoutParams.WRAP_CONTENT, android.widget.RelativeLayout.LayoutParams.WRAP_CONTENT);
		loadingParams.addRule(android.widget.RelativeLayout.CENTER_HORIZONTAL);
		loadingParams.addRule(android.widget.RelativeLayout.CENTER_VERTICAL);
		loading.setIndeterminate(true);
		loadingLayout.addView(loading, loadingParams);
		addView(loadingLayout, new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
	}
