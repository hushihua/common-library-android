 ...
 *
 */
public class SlideContentHeader extends RelativeLayout {

	private TextView text;
	private ImageView arrow;
	private ProgressBar progressBar;
	
	public SlideContentHeader(Context context) {
		super(context);
		initView();
	}

	public SlideContentHeader(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	}
